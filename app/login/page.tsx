    ...
    <main className="duyt-admin-login relative flex min-h-screen items-center justify-center overflow-hidden bg-[#F4F6FB] px-5 py-10 text-slate-950">
      ...
      <div className="relative z-10 w-full max-w-[500px]">
        <div className="mb-9 text-center">
          <div className="mx-auto grid h-[70px] w-[70px] place-items-center overflow-hidden rounded-[20px] bg-[#050505] p-3 shadow-[0_15px_35px_rgba(15,85,213,0.28)]"><img src={logo} alt="Logo DuyT Booking" className="h-full w-full object-contain" /></div>
