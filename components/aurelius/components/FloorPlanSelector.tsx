...
const FLOOR_PLAN_COPY: Record<Locale, {
  ...
  vi: { map: 'Sơ đồ bàn', choose: 'Chọn khu trước, sau đó chọn bàn', all: 'Tất cả khu', tables: 'bàn', layout: 'toàn bộ layout', zoom: 'Zoom để xem rõ nhiều bàn.', min: 'Chi tiêu tối thiểu', capacity: 'Sức chứa', upTo: 'Tối đa', from: 'Từ', booked: 'Bàn đã có lịch', request: 'Gửi yêu cầu đặt chổ', select: 'Chọn một bàn trên sơ đồ', selectHelp: 'Bấm vào từng khu, bàn hoặc phòng để xem mức chi tiêu tối thiểu, sức chứa và trạng thái.', helper: 'Bàn đã có lịch vẫn hiển thị với biểu tượng khóa và không thể chọn.', unavailable: 'Không khả dụng', area: 'Khu', managed: 'đang được quản lý trong hệ thống' },
