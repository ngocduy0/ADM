...
const bookingCopy = {
  vi: {
    ...
    security: "DuyT sẽ kiểm tra và xác nhận yêu cầu đặt chỗ của bạn.", checking: "Đang kiểm tra lịch bàn…", footer: "Kiểm tra đúng thông tin và tiến hành đặt chỗ.", sending: "Đang gửi...", soldOut: "Hết bàn ở khung giờ này",
    ...
    past: "ĐÃ QUA", lead: "CẦN ĐẶT TRƯỚC", minutes: "PHÚT", tableBooked: "BÀN ĐÃ CÓ LỊCH", nextDay: "+1 ngày", chooseFallback: "Chọn bàn", conciergeTable: "Concierge chọn bàn phù hợp", vipArea: "Khu VIP", namePlaceholder: " ",
