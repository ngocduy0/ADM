    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className={cn('relative flex shrink-0 items-center px-5 py-5', collapsed ? 'justify-center' : 'gap-3')}>
          <div className="grid h-11 w-11 shrink-0 place-items-center overflow-hidden rounded-xl bg-[#000000] shadow-lg shadow-[#1F3A8A]/20">
            <img src={settings.logoUrl || '/duyt-logo.png'} alt="Logo DuyT Booking" className="h-8 w-8 object-contain" />
          </div>
          {!collapsed ? (
            <div className="min-w-0">
              <h1 className="truncate text-lg font-extrabold tracking-tight text-[#000000]">DuyT Booking</h1>
