...
export function getAdminPageTitle(pathname: string) {
  ...
  // `/admin` is the parent of every admin route, so it must only match exactly.
  // Matching it with startsWith would incorrectly label pages such as Yêu cầu,
  // Khách hàng or Thông báo as "Tổng quan".
