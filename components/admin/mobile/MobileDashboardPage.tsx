        ...
        <section className="mt-4 grid grid-cols-2 gap-3">
          <article className="relative min-h-[108px] overflow-hidden rounded-2xl bg-[#2563EB] p-4 text-white shadow-[0_14px_30px_rgba(37,99,235,0.24)]">
            <div className="relative z-10">
              ...
              <p className="mt-3 inline-flex rounded-full bg-black/15 px-2 py-1 text-[9px] font-bold">Dữ liệu thời gian thực</p>
            </div>
            <span className="absolute -bottom-8 -right-7 h-24 w-24 rounded-full bg-black/10" />
          </article>
