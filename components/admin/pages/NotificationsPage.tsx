...
export function NotificationsPage() {
  ...
  return (
    <div className="pb-10">
      ...
      {rows.length ? <Card className="overflow-hidden p-0"><div className="divide-y divide-slate-100">{rows.map((notice) => {
      ...
      })}</div></Card> : <EmptyState icon={Bell} title="Không có thông báo" description="Booking mới và yêu cầu liên hệ trực tiếp sẽ xuất hiện tại đây." />}
    </div>
  );
}
