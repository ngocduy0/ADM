      ...
      <div className="grid gap-6 xl:grid-cols-[330px_minmax(0,1fr)]">
        <section>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-2xl border-2 border-dashed border-slate-200 px-4 py-4 text-center text-xs font-bold text-slate-400">Thứ tự được áp dụng ngay trên website sau khi lưu</div>
          </div>
        </section>

        <Card className="p-0">
          <div className="flex flex-col gap-4 border-b border-slate-100 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
            <div><h2 className="mt-1 text-xl font-black text-slate-950">{selected.title}</h2></div>
